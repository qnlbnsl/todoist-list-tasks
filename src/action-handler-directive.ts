...
// TODO You need to replace all instances of "action-handler-array" with "action-handler-<your card name>"
customElements.define('action-handler-array', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-array')) {
    return body.querySelector('action-handler-array') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-array');
